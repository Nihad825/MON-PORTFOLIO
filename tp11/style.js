...
function test_couleur(){
    ...
    else  if (couleur == "purple"|| couleur== "purle"){document.body.style.backgroundColor = "purple"
    }
    else  if (couleur == "brown"|| couleur== "brown"){document.body.style.backgroundColor = "brown"
    }
    else  if (couleur == "yellow"|| couleur== "yellow"){document.body.style.backgroundColor = "yellow"
    }
    else{

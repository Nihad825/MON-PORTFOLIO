...
--
-- Hôte : localhost
-- Généré le : mar. 18 nov. 2025 à 12:32
...
(1, 'PSG', 'OM', '2025-11-18 11:32:26', 1),
(2, 'Lakers ', 'Bulls', '2025-11-18 11:32:26', 2),
(3, 'Nadal', 'Federer', '2025-11-18 11:32:26', 3);
...
INSERT INTO `typeparis` (`id_typepari`, `description`) VALUES
...
(1, 'Dupont ', 'Marc', 'duponmarc@gmail.com'),
...
ALTER TABLE `pari`
  ...
  ADD CONSTRAINT `pari_ibfk_3` FOREIGN KEY (`id_typepari`) REFERENCES `typeparis` (`id_typepari`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pari_ibfk_4` FOREIGN KEY (`id_match`) REFERENCES `matchs` (`id_match`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
